const pt = {
	home: {
		...
		bio: {
			...
			p3: 'Agora estou indo com tudo para a engenharia de produto — dono do problema, da necessidade do usuário até a produção.',
			p4: {
